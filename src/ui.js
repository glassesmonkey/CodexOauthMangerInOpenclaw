    ...
    <script>
      ...
      function renderSpotlight(data) {
        ...
        quotaBoardDescription.textContent = rows.length
          ? "7d 总剩余按可读账号汇总；5h 总剩余只统计 7d 仍有余额且 5h 可读的账号。"
        ...
        quotaBoardTags.appendChild(createTag("5h 纳入 " + summary.primary.readableCount, summary.primary.readableCount ? "ok" : "warn"));
